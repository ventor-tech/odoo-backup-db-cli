...
from odoo_backup_db_cli.protocols.local import _local_handler
from odoo_backup_db_cli.utils import CodeError


@patch('odoo_backup_db_cli.protocols.local._local_delete_old_backups')
@patch('odoo_backup_db_cli.protocols.local._local_save_db')
@patch('odoo_backup_db_cli.protocols.local._local_save_filestore')
def test_ok(save_filestore_mock, save_db_mock, delete_old_backups_mock):
    ...
    res = _local_handler(config, 'test')
